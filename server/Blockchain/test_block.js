...
async function main() {
    ...
    const deployedContract = await contract.deploy({
        ...
        arguments: [proofData.proof.a, proofData.proof.b, proofData.proof.c, proofData.inputs],
        }).send({
        from: accountNumber,
        gas: '4700000',
    });
    ...
    const verif = await ContractVerif.methods.verifyTx(proofStruct, newInputs).call();
